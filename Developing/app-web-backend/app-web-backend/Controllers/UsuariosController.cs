...
namespace app_web_backend.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Status,Senha,Data_nasc")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Status,Senha,Data_nasc")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
